            ...
            <div className="relative group flex items-center gap-3">
              ...
              {!isSidebarCollapsed && (
                <div className="overflow-hidden">
                  <p className="text-xs font-black bg-gradient-to-r from-white via-blue-200 to-gray-400 bg-clip-text text-transparent uppercase tracking-[0.2em]">
                    {portalName}
                  </p>
                  <p className="text-[10px] text-blue-400 font-medium tracking-widest opacity-80 uppercase leading-none mt-0.5">Management</p>
                </div>
              )}
            </div>
          </div>
        ...
        <header ref={headerRef} className="h-20 bg-[#020617]/40 backdrop-blur-md border-b border-white/5 px-6 sm:px-10 flex items-center justify-between sticky top-0 z-40">
          <div className="flex items-center gap-5">
            <button
              ...
              className="p-2.5 text-gray-400 hover:text-white bg-white/5 hover:bg-white/10 rounded-xl transition-all shadow-lg shadow-black/20"
            >
