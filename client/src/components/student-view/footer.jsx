...
function Footer() {
  ...
  async function handleContactSubmit(e) {
    ...
    try {
      ...
      console.log(
        ...
        formData.fromName,
        "| Type:",
        typeof formData.fromName
      );
      console.log(
        "fromEmail:",
        formData.fromEmail,
        "| Type:",
        typeof formData.fromEmail
      );
      console.log(
        "phoneNumber:",
      ...
      console.log(
        ...
        formData.course,
        "| Type:",
        typeof formData.course
      );
      console.log(
        "segment:",
        formData.segment,
        "| Type:",
        typeof formData.segment
      );
      console.log(
        "institution:",
        formData.institution,
        "| Type:",
        typeof formData.institution
      );
      console.log(
        "message:",
        formData.message,
  ...
  return (
    <footer className="mt-12 border-t bg-gray-50 dark:bg-neutral-900">
      <div className="mx-auto max-w-7xl px-4 py-12 grid grid-cols-1 md:grid-cols-4 gap-10">
        <div>
          ...
          <div className="flex items-center gap-3 mt-2 text-gray-600 dark:text-gray-300">
            ...
            <a href="mailto:bravynex@gmail.com" className="hover:underline">
              bravynex@gmail.com
            </a>
          </div>
          <div className="flex items-center gap-4 mt-4">
            ...
            <a
              ...
              href="https://www.facebook.com/share/1Jp7Lpocmd/?mibextid=wwXIfr"
              target="_blank"
      ...
      <div className="text-center text-xs text-gray-500 dark:text-gray-400 py-5">
