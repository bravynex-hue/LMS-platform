        ...
        <div className="flex h-16 items-center justify-between gap-4">
          ...
          >
            ...
            <img
              ...
              style={{ maxHeight: '120px', maxWidth: '200px', objectFit: 'contain', transition: 'transform 0.2s',marginTop: '10px' }}
            />
          </Link>
            ...
            {auth?.authenticate ? (
              <>
                ...
                <DropdownMenu>
                  <DropdownMenuTrigger asChild>
                    <button
                      className="flex items-center justify-center gap-2 sm:px-3 px-2 py-2 rounded-lg transition-all duration-200"
                      style={{
                        background: "rgba(10,22,40,0.8)",
                        border: "1px solid rgba(59,130,246,0.15)",
                        color: "#f0f9ff",
                        height: "36px", // Ensuring uniform height
                      }}
                    >
                      <div className="w-7 h-7 sm:w-6 sm:h-6 flex-shrink-0 rounded-md flex items-center justify-center overflow-hidden"
                        style={{ background: "linear-gradient(135deg, #3b82f6, #a855f7)" }}>
                        {auth?.user?.avatar ? (
                          <img src={auth?.user?.avatar} alt="User Avatar" className="w-full h-full object-cover" />
                        ) : (
              ...
              <>
                <button
                  ...
                  className="hidden sm:flex items-center gap-1.5 text-sm font-semibold px-5 py-2 rounded-xl transition-all duration-300"
                  style={{
                    color: "#c8d6e5",
                ...
                <button
                  ...
                  onMouseEnter={(e) => {
                    e.currentTarget.style.boxShadow = "0 6px 30px rgba(59,130,246,0.4), inset 0 1px 0 rgba(255,255,255,0.15)";
                    e.currentTarget.style.transform = "translateY(-1px)";
                  }}
                  onMouseLeave={(e) => {
                    e.currentTarget.style.boxShadow = "0 4px 20px rgba(59,130,246,0.25), inset 0 1px 0 rgba(255,255,255,0.1)";
