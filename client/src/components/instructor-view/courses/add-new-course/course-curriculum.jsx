      ...
      <CardHeader className="border-b border-white/5 px-6 py-5">
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
          <div className="flex items-center gap-3">
            ...
            <CardTitle className="text-sm font-bold text-slate-200">Course Curriculum</CardTitle>
          </div>
          <div className="flex gap-3">
            ...
            <Button
              ...
              variant="outline"
              className="border-slate-800 text-slate-400 hover:bg-white/5 hover:text-white rounded-lg flex items-center gap-2 font-semibold transition-all"
            >
            ...
            <Button
              ...
              className="bg-blue-600 hover:bg-blue-700 text-white rounded-lg flex items-center gap-2 font-semibold shadow-md transition-all active:scale-95 translate-y-0"
            >
      ...
      <CardContent className="p-6">
        ...
        <div className="space-y-4">
          {courseCurriculumFormData.map((curriculumItem, index) => (
            <div
              key={index}
              className="border border-slate-800 bg-slate-900/50 hover:bg-slate-900/80 rounded-xl p-5 transition-all"
            >
              {/* Lecture header row */}
              <div className="flex flex-col md:flex-row md:items-center gap-4 mb-5">
                <span className="flex-shrink-0 w-24 text-xs font-bold text-blue-500 uppercase tracking-wider">
                  Module {index + 1}
                </span>
                <Input
                  name={`title-${index + 1}`}
                  placeholder="Enter lecture title"
                  className="flex-grow bg-slate-950 border-slate-800 text-white placeholder:text-slate-700 focus:border-blue-500/50 rounded-lg text-sm"
                ...
                <div className="flex items-center gap-2 ml-auto flex-shrink-0">
                  ...
                  />
                  <Label htmlFor={`freePreview-${index + 1}`} className="text-slate-500 text-xs font-medium cursor-pointer">
                    Preview Mode
                  </Label>
                </div>
              </div>
