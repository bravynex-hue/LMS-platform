    ...
    <div className="min-h-screen bg-[#020617]">
      ...
      <div className="p-6">
        <Tabs defaultValue="curriculum" className="space-y-5">
          <TabsList className="flex w-fit bg-transparent border-b border-white/5 rounded-none p-0 gap-8 h-auto">
            {[
              ...
              <TabsTrigger
                key={value}
                value={value}
                className="flex items-center gap-2 text-slate-400 data-[state=active]:bg-white/5 data-[state=active]:text-blue-400 data-[state=active]:border-b-2 data-[state=active]:border-blue-500 rounded-none text-sm font-semibold transition-all py-3 px-6"
              >
