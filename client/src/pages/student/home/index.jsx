...
function StudentHomePage() {
  ...
  useEffect(() => {
    ...
    tl.fromTo(".hero-badge-anim", { opacity: 0, y: 0 }, { opacity: 1, y: 0, duration: 0.5, ease: "power3.out" })
      .fromTo(".hero-title",      { opacity: 0, y: 0 },  { opacity: 1, y: 0, duration: 0.7, ease: "power3.out" }, "-=0.3")
      .fromTo(".hero-subtitle",   { opacity: 0, y: 0 },  { opacity: 1, y: 0, duration: 0.55, ease: "power2.out" }, "-=0.4")
      .fromTo(".hero-stats-row",  { opacity: 0, y: 0 },  { opacity: 1, y: 0, duration: 0.45, ease: "power2.out" }, "-=0.3")
      .fromTo(".hero-cta-row",    { opacity: 0, scale: 1 }, { opacity: 1, scale: 1, duration: 0.4, ease: "back.out(1.7)" }, "-=0.2");
  ...
  return (
    <div ref={pageRef} style={{ background: "var(--bg-dark)", color: "var(--text-primary)", minHeight: "100vh" }}>
      ...
      >
        ...
        {/* Dynamic Atmosphere Orbs layer */}
        <div className="absolute right-0 top-0 bottom-0 w-full lg:w-[50%] flex items-center justify-center p-12 overflow-hidden pointer-events-none opacity-60" style={{ zIndex: 0 }}>
           <div className="relative w-full h-full max-w-2xl">
              <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[550px] h-[550px] bg-blue-600/15 rounded-full blur-[120px] animate-orb" style={{ animationDuration: '25s' }} />
              <div className="absolute top-1/3 left-1/4 w-[350px] h-[350px] bg-purple-600/10 rounded-full blur-[100px] animate-orb" style={{ animationDuration: '30s', animationDirection: 'reverse' }} />
              <div className="absolute bottom-1/4 right-1/4 w-[450px] h-[450px] bg-cyan-500/10 rounded-full blur-[110px] animate-orb" style={{ animationDuration: '35s', animationDelay: '5s' }} />
           </div>
        </div>

        {/* Hero copy — left side */}
        <div className="relative z-10 w-full max-w-7xl mx-auto px-6 sm:px-8 sm:-ml-8 lg:px-36 lg:-ml-5 pt-20 pb-24">
          <div className="max-w-xl lg:max-w-2xl">

            {/* Main heading */}
            <h1 className="hero-title text-4xl sm:text-6xl lg:text-7xl font-black leading-[1.1] sm:leading-[1.04] tracking-tight mb-6">
            ...
            {/* CTAs */}
            <div className="hero-cta-row flex flex-col sm:flex-row gap-4 mb-10">
              <button
                onClick={() => navigate("/courses")}
                className="group relative flex items-center justify-center gap-3 h-10 sm:h-12 px-7 rounded-xl font-black uppercase tracking-[0.2em] text-[10px] text-white transition-all duration-500 overflow-hidden shadow-[0_15px_40px_rgba(37,99,235,0.2)]"
                style={{
              ...
              <button
                ...
                className="group relative inline-flex items-center justify-center gap-2 w-full sm:w-auto h-11 sm:h-12 px-6 sm:px-7 rounded-full border border-white/15 bg-white/5 text-[11px] sm:text-[10px] font-semibold uppercase tracking-[0.18em] sm:tracking-[0.2em] text-slate-200 transition-all duration-300 overflow-hidden hover:border-blue-400/70 hover:bg-white/10"
              >
                <div className="absolute inset-0 bg-gradient-to-r from-white/5 via-transparent to-white/5 opacity-0 group-hover:opacity-100 transition-opacity duration-300 pointer-events-none" />

                <Play className="w-4 h-4 text-slate-100 group-hover:scale-125 transition-transform duration-300 relative z-10" />
      ...
      <section className="py-24 px-6 sm:px-8 relative overflow-hidden"
        ...
        <div className="max-w-7xl mx-auto relative z-10">
          <div className="text-center mb-14 fade-up">
            ...
            <h2 className="text-3xl sm:text-5xl font-black mt-4 mb-4 break-words">
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            ...
            <div className="fade-up relative order-2 lg:order-1">
               <div className="relative aspect-square max-w-md mx-auto">
                  ...
                  {/* Floating Stat Cards */}
                  <div className="hidden sm:block absolute -top-4 right-0 md:-right-4 glass-card p-4 border-white/10">
                  ...
                  <div className="hidden sm:block absolute bottom-10 left-0 md:-left-10 glass-card p-4 border-white/10 animate-pulse">
                     <div className="flex items-center gap-3">
