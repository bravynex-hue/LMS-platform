...
function StudentFeedbackSupportPage() {
  ...
  // No entrance animations to avoid jumping
  useEffect(() => {
    return () => {
  ...
  return (
    <div className="relative w-full text-gray-200" style={{ background: "var(--bg-dark)" }}>
      {/* Background Decor */}
      <div className="orb orb-purple absolute w-[800px] h-[800px] -top-96 -left-40 opacity-[0.04] pointer-events-none" />
      <div className="orb orb-blue absolute w-[700px] h-[700px] bottom-0 -right-20 opacity-[0.03] pointer-events-none" />
      <div className="absolute inset-0 grid-bg opacity-[0.06] pointer-events-none" />

      {/* 3D Visual Atmosphere */}
      <div className="absolute inset-x-0 top-0 bottom-0 opacity-[0.15] pointer-events-none z-0">
         <Suspense fallback={null}>
            <FuturisticHeroScene />
         </Suspense>
      </div>

      <div className="relative z-10 max-w-[1400px] mx-auto px-6 lg:px-12 py-32 space-y-16">
        
        {/* Header Section */}
        <div className="flex flex-col md:flex-row justify-between items-start md:items-end gap-6">
          <div className="space-y-6">
            <span className="section-badge fb-badge">
              <ShieldCheck className="w-3 h-3" />
              Support Center
            </span>
            <h1 className="fb-title text-4xl md:text-6xl font-black text-white leading-tight">
              Feedback & <br />
          ...
          <Button
            ...
            className="fb-cta h-16 px-10 bg-blue-600 hover:bg-blue-700 text-white font-black uppercase tracking-[0.2em] text-[11px] rounded-2xl shadow-xl shadow-blue-600/30 transition-all"
          >
        ...
        {/* Tickets Grid/Table */}
        <div className="fb-history glass-card overflow-hidden border-white/10 backdrop-blur-2xl">
