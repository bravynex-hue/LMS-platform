...
const TEAM = [
  {
    ...
    name: "Mr. Chethan A R",
    role: "Chairman",
    photo: "/images/team/Chethan.jpeg",
    bio: "Strategic visionary and chairman of Bravynex, Chethan A R provides leadership guidance and long-term direction for the organization. He plays a key role in strengthening governance, fostering innovation, and building sustainable partnerships to accelerate technological advancement and empower the next generation of professionals.",
    socials: {}, // No socials
  },
  {
    id: "rohith",
        ...
        <div className="max-w-[1400px] mx-auto">
          <div className="max-w-3xl">
            ...
            <p className="about-desc text-lg sm:text-2xl text-gray-400 max-w-2xl leading-relaxed">
              Bravynex is a forward-thinking product and service-based company
      ...
      <div className="relative z-10 max-w-[1400px] mx-auto px-6 lg:px-12 pb-24">
        ...
        <div className="glass-card p-10 mb-24 text-center relative overflow-hidden">
          ...
          <p className="text-gray-400 max-w-3xl mx-auto mb-12">
            Registered under MSME and NSDC, affiliated with Visveswaraya
            Technological University (VTU) to ensure high-quality industrial
            standards.
          </p>
          {/* Commenting out the accreditation grid to prevent missing images and overflow layout breaking */}
          ...
          <div className="flex flex-col lg:flex-row items-center gap-12">
            <div className="flex-1">
              ...
              <p className="text-gray-400 text-lg leading-relaxed">
                Our trainers are industry veterans with{" "}
        ...
        <div className="mb-20">
          <div className="text-center mb-16">
            ...
            <h2 className="text-3xl sm:text-4xl font-black text-white">
              The Minds Behind <span className="text-blue-400">Bravynex</span>
            </h2>
          </div>
