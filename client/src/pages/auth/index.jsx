            ...
            {(activeTab === "signin" || activeTab === "signup") && (
              <div className="mt-4 space-y-4">
                ...
                <div className="grid grid-cols-2 gap-3">
                  <button
                    onClick={() => window.location.href = `${import.meta.env.VITE_API_BASE_URL || 'http://localhost:5000'}/auth/google?mode=${activeTab}`}
                  ...
                  <button
                    onClick={() => window.location.href = `${import.meta.env.VITE_API_BASE_URL || 'http://localhost:5000'}/auth/github?mode=${activeTab}`}
                    className="flex items-center justify-center gap-2 py-3 px-4 rounded-xl transition-all duration-300 group"
                    style={{ background: "rgba(15,23,42,0.9)", border: "1px solid rgba(59,130,246,0.12)" }}
                  >
                    <svg className="w-5 h-5 fill-[#f0f9ff] group-hover:scale-110 transition-transform" viewBox="0 0 24 24">
